...
BROCKEN_RC=`/opt/bin/kubectl get rc --namespace=ds-production |grep deepshare2-cookie- |awk '{print $1}'`
...
LAST_VERSION=`curl -s -S 'https://r.fds.so:5000/v2/ds-cookie/tags/list' | /home/core/deployment/jq '."tags"[]' |sort -n |tail -1| tr  -d '"'`
